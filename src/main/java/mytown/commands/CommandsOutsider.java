...
public class CommandsOutsider extends Commands {
    ...
    public static CommandResponse newTownCommand(ICommandSender sender, List<String> args) {
        ...
        final Resident res = MyTownUniverse.instance.getOrMakeResident(sender); // Attempt to get or make the Resident
        ...
        final Town town = getUniverse().newTown(args.get(0), res); // Attempt to create the Town
        if (town == null) {
